...
let
  ...
  k8s_versions_sha256 = {
    ...
    "1.13" =
      "TycofoLG9DBNv5nxxo2rEsHFtUBlgpYFfUeuoGjhzNk="; # Changed in last week xD
  ...
  kubernetes_open_api_specs = pkgs.lib.mapAttrs (version: sha256:
    pkgs.fetchurl {
      url =
        "https://github.com/kubernetes/kubernetes/raw/release-${version}/api/openapi-spec/swagger.json";
      sha256 = sha256;
    }) k8s_versions_sha256;
